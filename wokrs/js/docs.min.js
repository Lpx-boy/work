...
function AnchorJS(a) {
  ...
  this.add = function (a) {
    ...
    for (this._addBaselineStyles(), c = document.querySelectorAll('[id]'), d = [
...
!function (a, b) {
    ...
    function h(a) {
      ...
      if (h.lineCount > 1) {
        ...
        for (var p = 0; p < h.words.length; p++) {
          ...
          j = new e.Text(q.text);
          var r = '\\n' == q.text;
          (l + q.width >= n || r === !0) && (b(g, k, l, g.properties.leading), l = 0, m += g.properties.leading, o += 1, k = new e.Group('line' + o), k.y = m),
  ...
  function i(a, b, c) {
    ...
    f = Math.max(d, e),
    g = Math.min(d, e),
    h = 0.8 * Math.min(g, f * K.defaults.scale);
    return Math.round(Math.max(c, h))
  }
  function j(a) {
    var b;
    b = null == a || null == a.nodeType ? K.vars.resizableImages : [
      a
    ];
  ...
  function l() {
    for (var a, c = [
    ], d = Object.keys(K.vars.invisibleImages), e = 0, f = d.length; f > e; e++) a = K.vars.invisibleImages[d[e]],
...
(function (a) {
  ...
  b.encodeHtmlEntity = function (a) {
    for (var b = [
    ], c = 0, d = a.length - 1; d >= 0; d--) c = a.charCodeAt(d),
    b.unshift(c > 128 ? [
      '&#',
      c,
      ';'
  ...
  b.getNodeArray = function (b) {
    var c = null;
    return 'string' == typeof b ? c = document.querySelectorAll(b)  : a.NodeList && b instanceof a.NodeList ? c = b : a.Node && b instanceof a.Node ? c = [
      b
    ] : a.HTMLCollection && b instanceof a.HTMLCollection ? c = b : b instanceof Array ? c = b : null === b && (c = [
    ]),
    c
  },
...
var a = function (a, b) {
  ...
  if (null != a && '*' !== b[0] && ('string' == typeof a && (a = [
    a
  ]), 'object' == typeof a && 'length' in a)) for (c = 0, d = a.length; d > c; c++) if (a.hasOwnProperty(c) && (e = E(a[c]))) {
    if ('*' === e) {
      b.length = 0,
      b.push('*');
      break
...
var N = {
swfPath: m,
trustedDomains: a.location.host ? [
  a.location.host
] : [
],
cacheBust: !0,
...
for (var b = 0; b < a.length; b++) if (a.hasOwnProperty(b) && a[b] && 1 === a[b].nodeType) {
  a[b].zcClippingId ? - 1 === y(this.id, j[a[b].zcClippingId]) && j[a[b].zcClippingId].push(this.id)  : (a[b].zcClippingId = 'zcClippingId_' + i++, j[a[b].zcClippingId] = [
    this.id
